App.factory('ParallaxService', ['Toast', function (Toast) {
    return {
        ...
        getEventsForLayuot2: function(item) {
            return {
                onLike: function(item) {
                    Toast.showToast('Like');
                },
        ...
        getEventsForLayuot3: function(item) {
            return {
                onLike: function(item) {
                    Toast.showToast('Like');
                },
        ...
        getEventsForLayuot4: function(item) {
            return {
                onLike: function(item) {
                    Toast.showToast('Like');
                },
        ...
        getEventsForLayuot6: function(item) {
            return {
                onLike: function(item) {
                    Toast.showToast('Like');
                },
        ...
        getEventsForLayuot5: function(item) {
            return {
                onItemClick: function(item) {
